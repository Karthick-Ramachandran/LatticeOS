...
- Done: Define module responsibility, protocol, decision record, and test plan.
- Done: Commit three task manifests, task/result contracts, a deterministic validator, and a fixed
