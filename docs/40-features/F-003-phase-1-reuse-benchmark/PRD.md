...
pre-registered local tasks, including the exact treatment context, a raw delivery record, and an
auditable review of each submission.
...
- Recorded agent/config labels, fixture revision/hash, prompt/context artifacts, raw prompt-delivery
  artifacts, allowed diffs, test output, reviewer annotations, correction turns, appropriate and
  inappropriate canonical reuse, duplicate components, and raw Tailwind added.
...
- `docs/adrs/ADR-0020-require-delivery-evidence-for-reuse-benchmark-trials.md`
